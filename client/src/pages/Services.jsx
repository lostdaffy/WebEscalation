...
const Services = () => {
  ...
  const services = [
    {
      ...
      color: "from-[#0092b8] to-[#0092b8]",
      bgColor: "bg-cyan-50",
      borderColor: "border-cyan-200",
      textColor: "text-[#0092b8]",
      subServices: [
        {
          id: 1.1,
  ...
  return (
    <>
      ...
      <PageBanner
        heading="Services"
        subheading="Web & Graphic Design"
        description="Crafting fast, user‑centric websites and brand visuals that drive measurable business growth."
      />
              ...
              {services[0].subServices.map((service, index) => (
                <div
                  ...
                  className={`group cursor-pointer transition-all duration-500 ${
                    activeService === index
                      ? "bg-gray-50 border-l-4 border-[#0092b8]"
                      : "hover:bg-gray-50"
                  }`}
                ...
                >
                  <div className="flex items-center p-3 sm:p-4 space-x-3 sm:space-x-6">
                    <div className="text-sm sm:text-base font-bold text-gray-400 group-hover:text-[#0092b8] transition-colors">
                      {String(index + 1).padStart(2, "0")}
                    </div>
                    <div className="flex items-center space-x-3 sm:space-x-4 flex-1">
                      <div className="text-[#0092b8] opacity-60 group-hover:opacity-100 transition-opacity">
                        {service.icon}
                      </div>
                      <div className="flex-1">
                        <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 group-hover:text-[#0092b8] transition-colors">
                          {service.title}
                        </h3>
                    ...
                    <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-hover:text-[#0092b8] group-hover:translate-x-2 transition-all" />
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="lg:col-span-6 flex items-center justify-center min-h-screen py-12 sm:py-16">
            ...
            >
              ...
              <div className="text-center mb-8 sm:mb-12">
                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#0092b8] mb-4">
                  Email Services
                </h3>
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="group bg-white rounded-2xl p-4 sm:p-6 shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
                  <div className="flex items-start gap-4">
                    <div className="flex-1">
                      <h4 className="font-semibold text-gray-800 text-base sm:text-lg mb-2 group-hover:text-[#0092b8] transition-colors duration-300">
      ...
      <section
        ...
        className="min-h-screen relative overflow-hidden bg-white py-12 sm:py-16 lg:py-20"
      >
        <div className="absolute inset-0 bg-gradient-to-tl from-[#0092b8]/10 via-transparent to-transparent"></div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight text-gray-900">
                  Brand
                  <span className="text-[#0092b8]"> Identity</span>
                </h2>
              ...
              <div className="space-y-4 sm:space-y-6">
                {services[1].subServices.map((service, index) => (
                  ...
                  >
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#0092b8]/10 rounded-xl flex items-center justify-center mt-1 flex-shrink-0">
                      <div className="text-[#0092b8]">{service.icon}</div>
                    </div>
                    <div className="flex-1">
                      <h3 className="text-lg sm:text-xl font-semibold mb-2 text-gray-900 group-hover:text-[#0092b8] transition-colors">
                        {service.title}
                      </h3>
