  ...
  return (
    <footer className="bg-gray-100  relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-12 ">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
          ...
          <div className="space-y-4 sm:space-y-6 col-span-1 sm:col-span-2 lg:col-span-1">
            <div>
              ...
              <p className="text-xs sm:text-sm uppercase tracking-wider text-gray-800 mb-3 sm:mb-4">
            ...
            {/* Social Links */}
            <div className="flex space-x-3 sm:space-x-4 text-gray-800">
              <Link
          ...
          <div className="space-y-4 sm:space-y-6 ">
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li className="flex items-center gap-2 sm:gap-3 text-sm sm:text-base text-gray-800 hover:text-cyan-400 transition-colors duration-200">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link
                  to="/home"
                  className="text-sm sm:text-base text-gray-800 hover:text-cyan-400 transition-colors duration-200 hover:underline"
                >
                  Home
                </Link>
              </li>
          ...
          <div className="space-y-4 sm:space-y-6 col-span-1 sm:col-span-2 lg:col-span-1">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <Link
                  to="tel:+918273998875"
                  className="text-sm sm:text-base text-gray-800 hover:text-cyan-400 transition-colors duration-200"
                >
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <Link
                  ...
                  className="text-sm sm:text-base text-gray-800 hover:text-cyan-400 transition-colors duration-200 break-all sm:break-normal"
                >
        ...
        {/* Bottom Section */}
        <div className="border-t border-slate-700 mt-8 sm:mt-12 py-6 sm:py-8">
