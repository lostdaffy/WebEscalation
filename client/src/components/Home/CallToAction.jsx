  ...
  return (
    <div>
      ...
      <section className="min-h-screen sm:min-h-[75vh] lg:min-h-[60vh] flex items-center py-12 sm:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 w-full text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center mb-8 sm:mb-10 lg:mb-12">
              <button className="bg-cyan-500 hover:bg-cyan-700 text-white px-8 sm:px-10 py-3 rounded-full font-medium text-base sm:text-lg transition-all duration-200 hover:shadow-lg hover:shadow-cyan-500/30">
                Start Your Project
              </button>
              <button className="border-2 border-cyan-500 text-cyan-500 hover:bg-cyan-500 hover:text-white px-8 sm:px-10 py-3 rounded-full font-medium text-base sm:text-lg transition-all duration-200">
