  ...
  return (
    <div>
      <section className="min-h-screen sm:min-h-[75vh] lg:min-h-[60vh] bg-gradient-to-br from-slate-800 to-slate-900 flex items-center py-12 sm:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 w-full text-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {values.map((value, index) => (
              ...
              >
                <div className="bg-gradient-to-br from-cyan-500 to-cyan-500 w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 text-white group-hover:shadow-lg group-hover:shadow-cyan-500/50">
                  {value.icon}
                </div>
