          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {services.map((service, index) => (
              ...
              >
                ...
                <button className="flex items-center gap-2 text-cyan-600 hover:text-cyan-700 font-medium group-hover:gap-3 sm:group-hover:gap-4 transition-all duration-300 text-sm sm:text-base">
