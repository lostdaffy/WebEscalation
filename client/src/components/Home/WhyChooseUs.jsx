...
const WhyChooseUs = () => {
  ...
  return (
    <>
      <section
        ref={sectionRef}
        className="min-h-screen  flex items-center py-20 sm:py-16 lg:py-20"
      >
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
            ...
            <div className="w-full lg:basis-3/5 order-1 lg:order-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                <div
                  className={`bg-white rounded-xl shadow-md p-4 sm:p-5 border-l-4 border-cyan-500 transition-all duration-1000 delay-500 ${
                    isVisible
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-10"
                  }`}
                ...
                <div
                  className={`bg-white rounded-xl shadow-md p-4 sm:p-5 border-l-4 border-cyan-500 transition-all duration-1000 delay-700 ${
                    isVisible
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-10"
                  }`}
                ...
                <div
                  className={`bg-white rounded-xl shadow-md p-4 sm:p-5 border-l-4 border-cyan-500 transition-all duration-1000 delay-900 ${
                    isVisible
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-10"
                  }`}
                ...
                <div
                  className={`bg-white rounded-xl shadow-md p-4 sm:p-5 border-l-4 border-cyan-500 transition-all duration-1000 delay-1100 ${
                    isVisible
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-10"
                  }`}
